...
function set_sitter(object $pdo, int $user_id, int $zipcode, int $rate, array $available_days, array $available_times, array $size_pref, array $type_pref) 
{
    $query = "INSERT INTO Sitters (user_id, zipcode, rate, available_days, available_times, size_pref, type_pref) VALUES (:user_id, :zipcode, :rate, :available_days, :available_times, :size_pref, :type_pref);";
